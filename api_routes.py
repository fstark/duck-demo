...
def register_routes(mcp):
    ...
    async def api_stats_spotlight(request):
        ...
        with db_conn() as conn:
            ...
            # CUSTOMERS: most recently interacted (compute from MAX of related entities OR customer creation)
            customers_sql = """
            ...
            # QUOTES: newest + expiring soonest
            quotes = []
            # Newest (draft or sent)
            ...
            # Expiring soonest (sent, valid_until in future)
            ...
            # SALES ORDERS: largest + most urgent delivery
            orders = []
            # Largest open order (need to compute total from lines)
            ...
            # Most urgent (closest requested_delivery_date in future)
            ...
            # STOCK: low stock items (lowest on_hand for finished goods)
            ...
            # PURCHASE ORDERS: ordered + recently received
            purchase_orders = []
