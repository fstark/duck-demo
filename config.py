...
# QC constants
LOC_SCRAP = "SCRAP"
# Provider for QC inference: "myforterro" or "openai"
QC_INFERENCE_PROVIDER = os.getenv("QC_INFERENCE_PROVIDER", "myforterro")
QC_INFERENCE_MODEL = os.getenv("QC_INFERENCE_MODEL", "gpt-5.4")
